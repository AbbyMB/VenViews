...
Venue.create!( name: 'House of Blues', address: '15 Lansdown Street', description: 'Rock- & blues-themed chain with Southern dishes such as po boys & jambalaya, plus live music.', capacity: 200, url: 'http://www.houseofblues.com/', image: 'https://d2uqqhmijd5j2z.cloudfront.net/files/131579/venue_gallery/HouseOfBluesBostonMA.jpg?1482355562' )

Venue.create!( name: 'Hatch Shell', address: '47 David G Mugar Way', description: 'The Edward A. Hatch Memorial Shell is an outdoor concert venue on the Charles River Esplanade in the Back Bay section of Boston, Massachusetts.', capacity: 500, url: 'http://www.hatchshell.com/', image: 'https://9968c6ef49dc043599a5-e151928c3d69a5a4a2d07a8bf3efa90a.ssl.cf2.rackcdn.com/68958-1.jpg' )
