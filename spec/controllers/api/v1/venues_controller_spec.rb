...
RSpec.describe Api::V1::VenuesController, type: :controller do
  let!(:first_venue) { Venue.create(name: 'House of Blues', address: '15 Lansdown Street', description: 'house o blues yo', capacity: 200, url: 'http://www.houseofblues.com/') }
  let!(:second_venue) { Venue.create(name: 'Hatch Shell', address: '47 David G Mugar Way', description: 'The HALF shell', capacity: 500, url: 'http://www.hatchshell.com/') }
